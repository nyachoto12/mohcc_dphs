...
Route::middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::get('/d/{user}', 'App\Http\Controllers\DoctorsController@index')->name('show');
...
Route::middleware(['auth', 'isPatient'])->group(function () {
    ...
    Route::get('/p/{user}', 'App\Http\Controllers\PatientsController@index')->name('patient.show');
