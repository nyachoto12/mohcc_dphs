...
$dataPoints = [['y' => 57,963, 'label' => 'Confirmed Cases'], ['y' => 41,624, 'label'
=> 'Recoveries'], ['y' => 1,939, 'label' => 'Deaths']]; ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                    ...
                    <ul class="list-unstyled side">
                        ...
                        <li class="">
                            <a href="#profile" class="list-group-item list-group-item-action py-2 ripple "
                                ...
                                <i class="fas fa-clipboard-list text-info fa-2x me-3 mt-3"></i><span>Profile Management
                                </span></a>
    ...
    <script>
        ...
        // }
            ...
            $('.buttons-excel, .buttons-print, .buttons-pdf, .buttons-csv, .buttons-copy, pageLength').each(function () {
