...
<body>
                    ...
                    <ul class="list-unstyled side">
                        ...
                        <li class="">
                            ...
                            <ul class="collapse list-unstyled" id="profile">
                                <li class="m-2">
                                    <a href="{{ route('patient.edit',$patient->id) }}" class="btn btn-success pl-3 pr-3">Update</a>
                                </li>
                                @if (count($patients) == 0)
                                <li class="m-2">
                                ...
                                @else
                                <li class="m-2">
                                    <a href="#" class="btn btn-success pl-3 pr-3">My Profile</a>
                                </li>
                                @endif
    ...
    <div class="container">
        ...
        @endif
            <div class="card col-md-12 ml-5 mt-4" style="background-color: rgba(186, 214, 191, 0.856)">
                <div class="card-header text-center text-light bg-dark "> <h4>Hi {{ $patient->fullname }}</h4></div>
                ...
                <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between px-md-1">
                                                    <div>
                                                        ...
                                                        <p class="mb-0">Make A New Request</p>
                                                    </div>
                                                    <div class="align-self-center">
                    ...
                    <div class="row m-5">
                        <div class="card-header text-center text-light bg-dark mb-1"><h4>My Appointments</h4></div>
